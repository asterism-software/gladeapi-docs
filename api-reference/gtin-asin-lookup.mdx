---
title: "Amazon ASIN ↔ GTIN Conversion — Lookup Endpoints"
sidebarTitle: "GTIN / ASIN Lookup"
description: "Translate between Amazon ASINs and GTINs (barcodes) with two lightweight endpoints. Ideal for catalog reconciliation and enriching retail databases."
---
...
<ResponseField name="data.amazonProduct" type="object">
  <Expandable title="amazonProduct fields" defaultOpen>
    <ResponseField name="asin" type="string">
      The ASIN that was looked up, echoed back in the response.
    </ResponseField>
...
<ResponseField name="data.amazonProduct" type="object">
  <Expandable title="amazonProduct fields" defaultOpen>
    ...
    <ResponseField name="gtin" type="string">
      The GTIN that was looked up, echoed back in the response.
    </ResponseField>
  </Expandable>
</ResponseField>
