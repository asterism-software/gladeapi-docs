        ...
        <ResponseField name="results" type="array">
          ...
          <Expandable title="results[]">
            ...
            <ResponseField name="asin" type="string">
              Amazon Standard Identification Number uniquely identifying the product. Matches the pattern `^[A-Z0-9]{10}$`.
            </ResponseField>
            ...
            <ResponseField name="coupon" type="object | null">
              Coupon object if a coupon is available, otherwise `null`.
              <Expandable title="properties">
                <ResponseField name="label" type="string">
                  Coupon label displayed on Amazon (e.g., `"Save 10%"`).
                </ResponseField>
              </Expandable>
            </ResponseField>
          </Expandable>
