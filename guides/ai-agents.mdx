---
title: "Connect Glade API to AI Agents via MCP"
sidebarTitle: "AI Agents"
description: "Give AI agents and LLMs structured Amazon data access using Glade API's MCP endpoint. All 17 operations are exposed as typed tools with built-in prompt injection protection."
---
