...
Glade API offers four plans. Hobby and Pay as you go include 100 units; higher tiers include the quantities shown below.

| Plan | Price | Units included | Requests/min | Concurrent | Interfaces | Overage |
|---|---|---|---|---|---|---|
| **Hobby** | $0 | 100 | 30 | 2 | REST only | Hard cap (no overage) |
| **Pay as you go** | $0/month | 100 | 120 | 10 | REST + GraphQL + MCP | $0.01/unit |
| **Premium 20K** | $99/month | 20,000 | 600 | 50 | REST + GraphQL + MCP | $0.008/unit |
...
- **Pay as you go or Premium:** Enable overage billing explicitly in the dashboard if you want requests to continue beyond included units. You can also set a monthly spend limit.
